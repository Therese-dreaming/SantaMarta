<form action="{{ route('services.store') }}" method="POST" class="space-y-6">
    @csrf
    <input type="hidden" name="service_type" value="confirmation">

    <div class="mb-6">
        <label for="preferred_date" class="block text-sm font-medium text-gray-700">Confirmation Date <span class="text-red-500">*</span></label>
    ...
    <div class="mb-6">
        <label for="preferred_time" class="block text-sm font-medium text-gray-700">Confirmation Time <span class="text-red-500">*</span></label>
