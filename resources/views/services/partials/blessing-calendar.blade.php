<form action="{{ route('services.store') }}" method="POST" class="space-y-6">
    @csrf
    <input type="hidden" name="service_type" value="blessing">

    <div class="mb-6">
        <label for="preferred_date" class="block text-sm font-medium text-gray-700">Blessing Date <span class="text-red-500">*</span></label>
    ...
    <div class="mb-6">
        <label for="notes" class="block text-sm font-medium text-gray-700">Blessing Details <span class="text-red-500">*</span></label>
        <textarea id="notes" name="notes" rows="4" 
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
            placeholder="Please specify what needs to be blessed (e.g., house, car, religious items)"
