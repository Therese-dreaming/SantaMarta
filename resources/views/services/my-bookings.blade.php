    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('services.booking.details', $booking->id) }}" class="block">
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-lg relative border border-gray-100 dark:border-gray-600 cursor-pointer h-full flex flex-col w-full">
                    <div class="{{ 
                            ...
                            p-4 border-b border-gray-200 dark:border-gray-600 flex-grow">
